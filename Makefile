...
.PHONY: test-all test-auth test-conversation test-response test-response-aio test-response-mcp test-request test-model test-media test-mcp test-mcp-agents test-user-management test-model-prompts test-image test-agent-slide test-messages test-dev
